...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const chatsxz = (type === 'chat') ? body : (type === 'image' || type === 'video') ? caption : ''
		...
		const alphaNumber = [`6287778743613@s.whatsapp.net`]
...
const bayarLimit = (sender, amount) => {
	...
	//FUCNTION GOPLANET BY RIPAI
	   ...
	   //FUCNTION mining coal
        ...
        if (chatsxz == 'Assalamualaikum'){
          return reply(from, 'Waalaikumsalam wr wb.')
      }
      if (chatsxz == 'assalamualaikum'){
          return reply(from, 'Waalaikumsalam wr wb.')
      }
      if (chatsxz == 'Terimakasih'){
          return reply(from, 'Iya sama-sama..')
      }
      if (chatsxz == 'terimakasih'){
          return reply(from, 'Iya sama-sama..')
      }
      ...
      if (chatsxz == '#18+'){
          return reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*')
      }
      if (chatsxz == '#18+2'){
          return reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*')
      }
      if (chatsxz == '#stikerbokep'){
          return reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*')
      } 
      if (chatsxz == '#stickerbokep'){
          return reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*')
      }
      if (chatsxz == '#bokep'){
          return reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*')
      ...
      if (chatsxz == 'P'){
          alpha.sendMessage(from, fs.readFileSync('./media/nani-kore.mp3'))
      }
      if(text == 'p') {
  alpha.sendMessage(from, 'sama sama', MessageType.text)
}
      if (chatsxz == 'Oi'){
          alpha.sendMessage(from, fs.readFileSync('./media/nani-kore.mp3'))
      }
      ...
      if (chatsxz == 'Bot'){
          alpha.sendMessage(from, fs.readFileSync('./media/hai.mp3'))
      }
      if (chatsxz == 'bot'){
          alpha.sendMessage(from, fs.readFileSync('./media/hai.mp3'))
      }
      if (chatsxz == 'kontol'){
          alpha.sendMessage(from, fs.readFileSync('./media/astg.mp3'))
      }
      if (chatsxz == 'Tai'){
          alpha.sendMessage(from, fs.readFileSync('./media/astg.mp3'))
      }
      ...
      if (chatsxz == 'bacot') {
          alpha.sendMessage(from, './media/song.mp3')
      }
      if (chatsxz == 'kntl') {
          alpha.sendMessage(from, fs.readFileSync('./media/astg.mp3'))
      }
      ...
      if (chatsxz == 'Ngentod'){
          alpha.sendMessage(from, './media.astg.mp3')
      }
      if (chatsxz == 'Anjg'){
          alpha.sendMessage(from, fs.readFileSync('./media/astg.mp3'))
      }
     ...
     if (chatsxz == '#rhentai'){
      ...
      if (chatsxz == 'gajelas'){
          alpha.sendMessage(from, fs.readFileSync('./media/bakaa.mp3'))
      }
      if (chatsxz == 'Gajelas'){
          alpha.sendMessage(from, fs.readFileSync('./media/bakaa.mp3'))
      }
        ...
        const fakegroup = (teks) => {
            alpha.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
                        participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6287778743613-1604595598@g.us" } : {})
                    },
                    message: {
                        "imageMessage": {
                            "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
...
const bugtrol = { 
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"message": `${creator}`,
						"orderTitle": `${creator}`,
						"sellerJid": "6287778743613@s.whatsapp.net",
						"token": "AR5b5YFz2g4W5fYrjbeakPiI3/XxarATSeP+KLh+0FGwkw=="
					}}}
       const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6287778743613-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync(`image/${thumbnail}`), surface: 200, message: `Whatsapp Bot 〽️\nBy ${ownername}`, orderTitle: 'zeusxz', sellerJid: '0@s.whatsapp.net'}},contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        ...
        const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6287778743613@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} } 
        const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6287778743613@g.us" } : {})},message: {"videoMessage": { "title":`${creator}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `Whatsapp Bot 〽️\nBy ${ownername}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
		...
		const fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6287778743613@g.us" } : {}) },message: { "videoMessage": { "title":`${creator}`, "h": `Hmm`,'seconds': '99999', 'caption': `${creator}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
...
let id_vote = sender ? sender : '6287778743613@s.whatsapp.net'
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} itu owner ku yang paling cantikk dan lucu🐨...`
var buttonss = [
...
await limitAdd(sender, limit)
		...
		if (!isQuotedSticker) return reply('```Reply stc nya```')
		            ...
		            anu = args.join(' ').split('|')
		            satu = anu[0] !== '' ? anu[0] : `Created By`
		            dua = typeof anu[1] !== 'undefined' ? anu[1] : `@zeusxz_store`
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6287778743613-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 Bot by zeusxz 」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
       ...
       case 'ttp':  
         ...
         case 'attp':  
             ...
             case 'ktpmaker': case 'ktp':
                    if (args.length == 0) return reply(`Usage: ${prefix + command} nik|provinsi|kabupaten|nama|tempat, tanggal lahir|jenis kelamin|jalan|rt/rw|kelurahan|kecamatan|agama|status nikah|pekerjaan|warga negara|berlaku sampai|url_image|gol darah\n\nExample: ${prefix + command} .ktpmaker 456127893132123|bumipertiwi|fatamorgana|LoL Human|mars, 99-99-9999|belum|jl wardoyo|999/999|turese|imtuni|islam|jomblo kack|mikirin dia|indo|kiamat|https://i.ibb.co/Xb2pZ88/test.jpg|ab`)
                    ...
                    gdld = get_args[16]
                    reply('waitt')
                    bikinktp = (`https://ferdiz-afk.my.id//api/Fmake/ktpmaker?nik=${nik}&nama=${name}&ttl=${ttl}&jk=${jk}&gd=${gdld}&almt=${jl}&rtw=${rtrw}&kel=${lurah}&kc=${camat}&agm=${agama}&st=${nikah}&krj=${kerja}&ngr=${warga}&blk=${until}&prv=${prov}&kab=${kabu}&picturl=${img}`)
                      console.log(bikinktp)
                    imge = await getBuffer(bikinktp)
                    await alpha.sendMessage(from, imge, image, { quoted: mek, thumbnail: Buffer.alloc(0) });
                    await limitAdd(sender, limit)
					break 
        case 'nulis2':
...
case 'igstalk2':
case 'stalkig2':
            if (args.length === 1)  return alpha.reply(from, 'Kirim perintah *!igstalk username*\nConntoh *!igstalk zeusxz_store*')
            const stalk = await fetchJson(`https://cakrayp.herokuapp.com/api/instagram/stalk/?username=${args[1]}&apikey=cakrayp24Q6`)                
            const caps = `➸ *Full Nama* : ${stalk.data.result.fullname}\n➸ *Username* : ${stalk.data.result.username}\n➸ *Jumlah Followers* : ${stalk.data.result.followers}\n➸ *Jumlah Following* : ${stalk.data.result.following}\n➸ *Biodata* : ${stalk.data.result.biography}`
            await alpha.sendFileFromUrl(from, stalk.data.resul.profile_pic, 'Profile.jpg', caps, id)
