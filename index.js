	...
	//FUCNTION GOPLANET BY RIPAI
	   ...
	   //FUCNTION mining coal
        ...
        if (chats == 'Assalamualaikum'){
          reply(from, 'Waalaikumsalam wr wb.', id)
      }
      if (chats == 'assalamualaikum'){
          reply(from, 'Waalaikumsalam wr wb.', id)
      }
      if (chats == 'Terimakasih'){
          reply(from, 'Iya sama-sama..', id)
      }
      if (chats == 'terimakasih'){
          reply(from, 'Iya sama-sama..', id)
      }
      ...
      if (chats == '#18+'){
          reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*', id)
      }
      if (chats == '#18+2'){
          reply(from, '*Demi kenyamanan bersama,*\n*Maaf menu ini telah di hapus!.*', id)
      }
      ...
      if (chats == 'P'){
          alpha.sendMessage(from, './media/nani-kore.mp3', id)
      }
      if (chats == 'p'){
          alpha.sendMessage(from, './media/nani-kore.mp3', id)
      }
      ...
      if (chats == 'Bot'){
          alpha.sendMessage(from, './media/hai.mp3', id)
      }
      if (chats == 'bot'){
          alpha.sendMessage(from, './media/hai.mp3', id)
      }
      if (chats == 'kontol'){
          alpha.sendMessage(from, './media/astg.mp3', id)
      }
      if (chats == 'Tai'){
          alpha.sendMessage(from, './media/astg.mp3', id)
      }
      ...
      if (chats == 'bacot') {
          alpha.sendMessage(from, './media/song.mp3', id)
      }
      if (chats == 'kntl') {
          alpha.sendMessage(from, './media/astg.mp3', id)
      }
     ...
     if (chats == '#rhentai'){
      ...
      if (chats == 'gajelas'){
          alpha.sendMessage(from, './media/bakaa.mp3', id)
      }
      if (chats == 'Gajelas'){
          alpha.sendMessage(from, './media/bakaa.mp3', id)
      }
