       ...
       case 'ttp':  
         ...
         case 'attp':  
             ...
             case 'ktpmaker': case 'ktp':
                    ...
                    gdld = get_args[16]
                    reply('waitt')
                    bikin = (`https://ferdiz-afk.my.id//api/Fmaker/ktp?nik=${nik}&nama=${name}&ttl=${ttl}&jk=${jk}&gd=${gdld}&almt=${jl}&rtw=${rtrw}&kel=${lurah}&kc=${camat}&agm=${agama}&st=${nikah}&krj=${kerja}&ngr=${warga}&blk=${until}&prv=${prov}&kab=${kabu}&picturl=${img}`)
                      console.log(bikin)
